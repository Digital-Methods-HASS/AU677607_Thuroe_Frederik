---
title: "W47 - Make Data Move"
author: "Frederik Thurøe"
date: "29/11/2021"
...
It makes it easier to detect, when something is much larger than the others. It makes sure, that the graph won't get distorted. 
...
The country on the far right is Kuwait. 
...
Just used the function ggtitle, to give the animation a name. I called it "Animation"
...
I added both a title "Animation" and changed the names on the axis, using the "ylab" and "xlab". I also gave it different colors based on the continents, using the geom_point(aes(color = continent)) 
...
anim2 <- ggplot(gapminder, aes(gdpPercap, lifeExp, size = pop)) +
  ...
  transition_time(year) +
  ggtitle("Animation") +
  ylab("Life Expectancy") +xlab ("GPD pr. CAP")
anim2
```
...
I used so much time on the first 6 questions, that I didn't have any time left for this one. 
